...
public final class ImageDownloader {
     ...
     */
    public func downloadImage(with imageUrlString: String?,
    ...
    public func cancelPreviousTask(with urlString: String?) {
    ...
    public func getDataTaskFrom(urlString: String) -> URLSessionTask? {
